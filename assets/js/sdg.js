...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles, startValues, proxy, proxySerieses, allObservationAttributes) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"subfolder":"Territorio","label":"Territorio","min_zoom":2,"max_zoom":7,"staticBorders":true},{"subfolder":"Comarca","label":"Comarca","min_zoom":8,"max_zoom":9,"staticBorders":true},{"subfolder":"Municipio","label":"Municipio","min_zoom":10,"max_zoom":14,"staticBorders":true}],
      precision: precision,
