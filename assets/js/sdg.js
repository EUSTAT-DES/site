...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles, startValues, proxy, proxySerieses, allObservationAttributes) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"subfolder":"Territorio","label":"Territorio","min_zoom":4,"max_zoom":6,"staticBorders":true},{"subfolder":"Comarca","label":"Comarca","min_zoom":7,"max_zoom":8,"staticBorders":true},{"subfolder":"Municipio","label":"Municipio","min_zoom":9,"max_zoom":12,"staticBorders":true}],
      precision: precision,
